...
public class HumidityResource extends CoapResource {
	 ...
	 * @param mote
	 */
    public HumidityResource(CoapResource mote) {
        super("humidity");
        this.mote = mote;
        this.getAttributes().setTitle(mote.getAttributes().getTitle() + " Humidity Resource");
    }
    ...
    public void handleGET(CoapExchange exchange) {
    	String payload = ""
    			+ "<mote id=\"" + this.mote.getName() + "\">"
    				+ "<humidity path=\"" + this.getURI() + "\" unit=\"%\">83</humidity>"
    			+ "</mote>";
